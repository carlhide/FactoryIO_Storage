...
export AS_STATIC_ARCHIVES_PATH := c:/repos/local/FactoryIO_Storage/Temp/Archives/Config1/PC
export AS_CPU_PATH := c:/repos/local/FactoryIO_Storage/Temp/Objects/Config1/PC
export AS_CPU_PATH_2 := c:/repos/local/FactoryIO_Storage/Temp/Objects/Config1/PC
export AS_TEMP_PATH := c:/repos/local/FactoryIO_Storage/Temp
export AS_BINARIES_PATH := c:/repos/local/FactoryIO_Storage/Binaries
export AS_PROJECT_CPU_PATH := c:/repos/local/FactoryIO_Storage/Physical/Config1/PC
export AS_PROJECT_CONFIG_PATH := c:/repos/local/FactoryIO_Storage/Physical/Config1
